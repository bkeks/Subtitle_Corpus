...
# open csv file
file = open('past_vs_perfect.csv', 'w') # no restrictions

writer = csv.writer(file)

csv_header = ['Präteritum', 'Perfekt'] # no restrictions
...
for id in db_result:
    ...
    for sentence in sentences:
        ...
        for word in sentence:
            str_sentence = str_sentence + str(word[11]) + " "
    ...
    if counter_files >= 1000:
        print("Sätze in Präteritum:" + str(past_tense))
        print("Sätze in Perfekt:" + str(perfect_tense))
        exit()
