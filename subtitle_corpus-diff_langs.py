...
# open csv file
file = open('past_vs_perfect-different_lang.csv', 'w', newline='', encoding='utf-8') # comparison of different original languages

writer = csv.writer(file)

csv_header = ['Präteritum', 'Perfekt', 'Englisch', 'Deutsch', 'Andere Sprachen'] # comparison of different original languages
...
for id in db_result:
    ...
    for sentence in sentences:
        ...
        for word in sentence:
            ...
            if re.match(r'^English', item[4]):
                #### English movie
                if word[15] == "Past" and word[14] == "Fin":
                    past_tense_en += 1
                    writer.writerow(['1','0','1','0','0'])

                elif word[14] == "Part":
                    for word in sentence:
                        if word[15] == "Pres":
                            perfect_tense_en += 1
                            writer.writerow(['0','1','1','0','0'])

            elif re.match(r'^German', item[4]):
                #### German movie
                if word[15] == "Past" and word[14] == "Fin":
                    past_tense_de += 1
                    writer.writerow(['1','0','0','1','0'])
...
print("Präteritum Englisch:        " + str(past_tense_en))
print("Perfekt Englisch:           " + str(perfect_tense_en))
print("Präteritum Deutsch:         " + str(past_tense_de))
print("Perfekt Deutsch:            " + str(perfect_tense_de))
print("Präteritum Andere Sprachen: " + str(past_tense_other))
print("Perfekt Andere Sprachen:    " + str(perfect_tense_other))
        #exit()
